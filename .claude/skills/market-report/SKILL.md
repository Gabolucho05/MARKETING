---
name: market-report
description: "Marketing report generator (Markdown format). Compiles data from prior audit and analysis skills into a single client-ready report with scores, findings, recommendations, and a prioritized action plan. Triggered by /market report or /market report <domain>. Use when the user wants a compiled marketing report or scorecard."
---
