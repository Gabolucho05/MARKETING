---
name: market
description: "Main entry point and command router for the AI Marketing Suite. Use when the user types /market or asks to run a marketing audit, analyze a website/URL for marketing effectiveness, or wants any of the suite's deliverables (audit, copy, emails, social, ads, funnel, competitors, landing page CRO, launch plan, client proposal, SEO audit, brand voice, or report) for a business or website."
---
