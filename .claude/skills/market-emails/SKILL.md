---
name: market-emails
description: "Email sequence generation engine for /market emails <topic/url>. Produces complete, ready-to-send email sequences with subject lines, body copy, timing, and segmentation built on proven email marketing frameworks. Use when the user needs welcome, nurture, or launch email sequences."
---
