...
description: "PDF marketing report generator. Invokes scripts/generate_pdf_report.py to produce a branded, visually polished PDF with score gauges, charts, tables, findings, and an action plan. Triggered by /market report-pdf or /market report-pdf <domain>. Use when the user wants a polished, client-ready PDF report rather than Markdown."
---
