---
name: market-funnel
description: "Sales funnel analysis engine for /market funnel <url>. Maps the full conversion path from first visit to purchase, identifies drop-off points, quantifies friction, and recommends prioritized optimizations with revenue impact estimates. Use when the user wants funnel analysis or conversion path optimization."
---
