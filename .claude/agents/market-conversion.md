...
description: "Conversion rate optimization (CRO) subagent used by /market audit to evaluate a website's Conversion Optimization dimension. Analyzes conversion barriers and friction points across the user journey."
---
